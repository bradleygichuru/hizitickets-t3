...
const DashBoard = () => {
  ...
  const onSubmit: SubmitHandler<FormSchemaType> = async (data) => {
    ...
    if (eventPoster) {
      ...
      toast({ title: "Field empty", description: "Event poster required", status: "error", duration: 9000 })
    }
  };
              ...
              <ModalBody>
                <div className="mt-2">
                  ...
                  >
                    ...
                    <div className="dropdown">
                      ...
                      >
                        ...
                        <div className="m-2 flex flex-col rounded-lg border-2 border-neutral">
                          ...
                          <input
                            type="text"
                            {...register("ticketType1Name", { required: true })}
                    ...
                    {(errors.ticketType1Date || errors.ticketType1Price || errors.ticketType1Name) && (
                      <label className="label">
                        <span className="text-red-900">
                          This field is required
                        </span>
                      ...
                      <div className="mt-1 flex justify-center rounded-md border-2 border-dashed border-gray-300 px-6 pt-5 pb-6">
                        <div className="space-y-1 text-center">
                          ...
                          <div className="flex text-sm text-gray-600">
                            ...
                            >
                              {eventPoster ? (<span>{eventPoster.name}</span>) : (<span>Upload a file</span>)}
                              <input
                                id="file-upload"
                                name="file-upload"
                                type="file"
                            ...
                            {eventPoster ? ("") : (<p className="pl-1">or drag and drop</p>)}
                          </div>
                          {eventPoster ? ("") : (<p className="text-xs text-gray-500">
